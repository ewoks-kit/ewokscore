...
- `TaskGraph.analysis`: graph analysis with caching.

### Deprecated

- `ewokscore.graph.analysis`: use `TaskGraph.analysis` instead.
- `ewokscore.graph.taskgraph`: `node_has_links` is deprecated and will be removed.

### Fixed

- `GraphAnalysis.node_pure_descendants` now returns all pure descendants of the node, not just the
  direct ones like the deprecated `analysis.node_pure_descendants` still does.
- `GraphAnalysis.node_has_noncovered_conditions` now treats a `True`/`False` condition value as
  covered when the complementary link exists, not as always non-covered like the deprecated
  `analysis.node_has_noncovered_conditions` still does.
...
- Make functions in `ewokscore.tests.test_workflow_events` public again.
...
- Ewoks event: reset event logger when an event requires different handlers than the current handlers.

### Removed

- Module `ewokscore.persistence.uri`.
...
[2.0.1]: https://github.com/ewoks-kit/ewokscore/compare/v2.0.0...v2.0.1
[2.0.0]: https://github.com/ewoks-kit/ewokscore/compare/v1.6.0...v2.0.0
[1.6.0]: https://github.com/ewoks-kit/ewokscore/compare/v1.5.0...v1.6.0
[1.5.0]: https://github.com/ewoks-kit/ewokscore/compare/v1.4.0...v1.5.0
[1.4.0]: https://github.com/ewoks-kit/ewokscore/compare/v1.3.0...v1.4.0
[1.3.0]: https://github.com/ewoks-kit/ewokscore/compare/v1.2.0...v1.3.0
[1.2.0]: https://github.com/ewoks-kit/ewokscore/compare/v1.1.0...v1.2.0
[1.1.0]: https://github.com/ewoks-kit/ewokscore/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.15.0...v1.0.0
[0.15.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.14.0...v0.15.0
[0.14.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.13.1...v0.14.0
[0.13.1]: https://github.com/ewoks-kit/ewokscore/compare/v0.13.0...v0.13.1
[0.13.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.12.0...v0.13.0
[0.12.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.11.0...v0.12.0
[0.11.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.10.0...v0.11.0
[0.10.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.9.0...v0.10.0
[0.9.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.8.1...v0.9.0
[0.8.1]: https://github.com/ewoks-kit/ewokscore/compare/v0.8.0...v0.8.1
[0.8.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.7.4...v0.8.0
[0.7.4]: https://github.com/ewoks-kit/ewokscore/compare/v0.7.3...v0.7.4
[0.7.3]: https://github.com/ewoks-kit/ewokscore/compare/v0.7.2...v0.7.3
[0.7.2]: https://github.com/ewoks-kit/ewokscore/compare/v0.7.1...v0.7.2
[0.7.1]: https://github.com/ewoks-kit/ewokscore/compare/v0.7.0...v0.7.1
[0.7.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.6.1...v0.7.0
[0.6.1]: https://github.com/ewoks-kit/ewokscore/compare/v0.6.0...v0.6.1
[0.6.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.5.3...v0.6.0
[0.5.3]: https://github.com/ewoks-kit/ewokscore/compare/v0.5.2...v0.5.3
[0.5.2]: https://github.com/ewoks-kit/ewokscore/compare/v0.5.1...v0.5.2
[0.5.1]: https://github.com/ewoks-kit/ewokscore/compare/v0.5.0...v0.5.1
[0.5.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.4.3...v0.5.0
[0.4.3]: https://github.com/ewoks-kit/ewokscore/compare/v0.4.2...v0.4.3
[0.4.2]: https://github.com/ewoks-kit/ewokscore/compare/v0.4.1...v0.4.2
[0.4.1]: https://github.com/ewoks-kit/ewokscore/compare/v0.4.0...v0.4.1
[0.4.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.3.3...v0.4.0
[0.3.3]: https://github.com/ewoks-kit/ewokscore/compare/v0.3.2...v0.3.3
[0.3.2]: https://github.com/ewoks-kit/ewokscore/compare/v0.3.1...v0.3.2
[0.3.1]: https://github.com/ewoks-kit/ewokscore/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.2.1...v0.3.0
[0.2.1]: https://github.com/ewoks-kit/ewokscore/compare/v0.2.0...v0.2.1
[0.2.0]: https://github.com/ewoks-kit/ewokscore/compare/v0.1.1...v0.2.0
[0.1.1]: https://github.com/ewoks-kit/ewokscore/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/ewoks-kit/ewokscore/releases/tag/v0.1.0
